...
class RelationshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create relationship" do
    assert_difference('Relationship.count') do
      post relationships_url, params: { relationship: { follower_id: @relationship.follower_id, following_id: @relationship.following_id } }
    end
  ...
  test "should update relationship" do
    patch relationship_url(@relationship), params: { relationship: { follower_id: @relationship.follower_id, following_id: @relationship.following_id } }
